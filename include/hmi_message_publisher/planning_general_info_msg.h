...
static const google::protobuf::EnumDescriptor* TrajectoryType_descriptor =
        drive::common::planning::PlanningTrajectory::TrajectoryType_descriptor();
...
class PlanningGeneralInfo {
  public:
    PlanningGeneralInfo();
    PlanningGeneralInfo(const bool& allow_lane_change,
