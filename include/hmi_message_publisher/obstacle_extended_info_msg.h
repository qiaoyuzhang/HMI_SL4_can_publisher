...
class ObstacleExtendedInfo {
    public:
        ...
        ObstacleExtendedInfo(const unsigned int& ob_id, const unsigned int& lane_assignment, const double& dist_long, const double& dist_lat, const int& ob_class, const bool& ob_threat);
