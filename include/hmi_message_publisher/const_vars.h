...
struct DataConfigInt {
    ...
    DataConfigInt(const unsigned char& data_start,
    ...
    int recoverValue(const unsigned int& data) const { return data * resolution + offset; }
...
struct DataConfigDouble {
    ...
    DataConfigDouble(const unsigned char& data_start,
                     const unsigned char& len,
                     const double& offset,
    ...
    double recoverValue(const unsigned int& data) const { return data * resolution + offset; }
...
struct DataConfigBool {
    ...
    DataConfigBool(const unsigned char& data_start) : data_start(data_start) {}

    bool recoverValue(const unsigned int& data) const { return data == 0 ? false : true; }
    ...
    unsigned int getData(const bool& value) const { return value ? 1 : 0; }
...
static const unsigned int VehicleStatusGeneralInfo_data_total_bit =
        21;  // sum of all lens in the message
static const unsigned int VehicleStatusGeneralInfo_data_size =
        n_byte(VehicleStatusGeneralInfo_data_total_bit);
...
static const unsigned int ObstacleGeneralInfo_data_size =
        n_byte(ObstacleGeneralInfo_data_total_bit);
...
static const unsigned int ObstacleExtendedInfo_data_total_bit =
        32;  // sum of all lens in the message
static const unsigned int ObstacleExtendedInfo_data_size =
        n_byte(ObstacleExtendedInfo_data_total_bit);
...
static const unsigned int PlanningGeneralInfo_data_total_bit = 19;  // sum of all lens in the
                                                                    // message
static const unsigned int PlanningGeneralInfo_data_size =
        n_byte(PlanningGeneralInfo_data_total_bit);
