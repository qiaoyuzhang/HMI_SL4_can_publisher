...
PlanningGeneralInfo::PlanningGeneralInfo(const bool& allow_lane_change,
                                         const bool& left_lane_change_cmd,
                                         const bool& right_lane_change_cmd,
                                         const int& set_speed,
...
void PlanningGeneralInfo::setLeftLaneChangeCmd(const bool& left_lane_change_cmd) {
    PlanningGeneralInfo_left_lane_change_cmd.writeValueToDataVector(_data_vec,
                                                                    left_lane_change_cmd);
}
...
void PlanningGeneralInfo::setRightLaneChangeCmd(const bool& right_lane_change_cmd) {
    PlanningGeneralInfo_right_lane_change_cmd.writeValueToDataVector(_data_vec,
                                                                     right_lane_change_cmd);
}
