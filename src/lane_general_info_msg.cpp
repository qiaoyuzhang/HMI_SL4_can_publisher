...
void LaneGeneralInfo::setLeftLaneExist(const bool& left_lane_exist) {
    ...
    writeDataToDataVector(_data_vec,
                          LaneGeneralInfo_left_lane_exist.data_start,
                          LaneGeneralInfo_left_lane_exist.len,
                          data);
}
bool LaneGeneralInfo::getLeftLaneExist() {
    unsigned int data = 0;
    getDataFromDataVector(_data_vec,
                          LaneGeneralInfo_left_lane_exist.data_start,
                          LaneGeneralInfo_left_lane_exist.len,
                          data);
...
void LaneGeneralInfo::setRightLaneExist(const bool& right_lane_exist) {
    ...
    writeDataToDataVector(_data_vec,
                          LaneGeneralInfo_right_lane_exist.data_start,
                          LaneGeneralInfo_right_lane_exist.len,
                          data);
}
